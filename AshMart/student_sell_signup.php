...
<?php
   ...
   if(isset($_POST['save'])){
    ...
    mysql_query("insert into student_post  (firstname, lastname, othername,  email, class, phone_number,  password)
     values('$firstname', '$lastname', '$othername','$email', '$class', '$phone','$passhash')")or die(mysql_error());
